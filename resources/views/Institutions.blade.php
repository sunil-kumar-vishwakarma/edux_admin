...
.card1 button {
  ...
  .choices__list {
    width: 60%; /* Ensure the dropdown list has the same width */
  }
  ...
  .choices__list {
    display: block;  /* Make the list block-level to stack each item */
  }
  ...
  .choices {
    ...
    max-width: 100%; /* Ensures it doesn’t overflow in smaller containers */
  }

  /* Optional: Increase the width of the dropdown list */
  .choices__list--dropdown .choices__list {
    width: 400px; /* Matches the dropdown field width */
    max-width: 100%;
  }
...
.login-container {
  ...
  gap: 20px;  /* Adds space between the image and form */
  max-width: 1000px;  /* Adjust the container's width */
...
.left-side .image {
  width: 100%;  /* Makes the image take up the full width of the left side */
  height: auto; /* Maintains the aspect ratio */
  max-width: 400px; /* Adjusts the maximum width of the image */
}

/* Right side (form) styling */
.right-side {
  flex: 1.5;  /* Takes up more space than the image side */
}
...
.login-container input, select, textarea {
  ...
  width: 103%;  /* Full width for each input field */
}
...
.checkbox-container {
  ...
  align-items: left;  /* Center-aligns the checkbox and label */
  gap: 4px;  
}
...
#firstcol li a:hover{
    text-decoration:none;
        ...
        <div class="text">
          ...
          <p>Increase your global presence and the number of qualified students from a single, easy-to-use platform trusted by more than 1,500 institutions worldwide.</p>
       ...
       <section class="journey">  
           <div class="journey-section">
            <h2>Your journey at a glance <span>👇</span></h2>
            <div class="journey-steps">
                ...
                <div class="step">
                    ...
                    <p>Sign up for our <a href="#">FREE virtual events</a> to speak to universities worldwide</p>
                </div>
                <div class="connector"><i class="fa-solid fa-arrow-right-long"></i></div>
                <div class="step">
                    <div class="icon">🌐</div>
                    <h3>Stay up to date</h3>
                    <p>Follow us on <a href="#">Instagram</a>, <a href="#">TikTok</a>, and <a href="#">YouTube</a> for scholarship and study abroad updates</p>
                </div>
            </div>
        </div>
       </section>
    ...
    Here to help you grow your business by offering the best opportunities and support.</p>
     ...
     <div class="container1">
        ...
        <p style="text-align: center; white-space: nowrap; margin-left: 371px; font-size: larger;">Attract the best students from around the world with Edux.</p>
    <br>
      ...
      <section class="working">
       ...
       <section class="country-section">
        ...
        <button style="height:80px; width:300px; font-size:35px; font-weight:bold;" class="btn btn-primary"><a href="#">Work With Us</a></button>
      </section>
      ...
      <div class="container1">
        ...
        <div class="card-container">
          <div class="card-institutions">
            <div class="icon"><img src="images/Machine_Learning-pdfy8jys8c4u5yl9xfc2xsl44csh106t79gbivp4w8.png" alt="Local Support Icon"></div>
            <h3>Local Support</h3>
            <p>Our international recruitment experts are there to support you every step of the way.</p>
          </div>
          
          <div class="card-institutions">
            <div class="icon"><img src="images/Big-Data-Analytics-pdfy8cg2pnujl2w75c32duhfd9tjbfcyi88foo0aa0.png" alt="Education Icon"></div>
          ...
          <div class="card-institutions">
            <div class="icon"><img src="images/Security_Privacy-pdfy84xd6zk90774d8u1twdqm6ulluj3t70jugbfns.png" alt="Events Icon"></div>
          ...
          <div class="card-institutions">
            <div class="icon"><img src="images/Co-Created_Progras-pdfy7xenob9yfbi1l5l19ya1v3vnw9p945so08ml1k.png" alt="Data Icon"></div>
      ...
      <section class="global">
        ...
        <p style="text-align: center; white-space: nowrap; margin-left: 371px; font-size: larger;">Our 1,000+ team members are as
            diverse as the students we support</p>
   ...
   <span class="error" id="countryError">Please select a country.</span>
            ...
            <div class="checkbox-group">
                ...
                <label for="checkbox1" style="margin-left: -419px;">I agree to the privacy policy *</label>
            </div>
