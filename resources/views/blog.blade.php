...
@section('content')
    ...
    <div class="card18">
        <div class="row-cols-1 row-cols-md-3 g-4" style="display: flex; flex-wrap: wrap; gap: 20px;">
            @foreach ($blogs as $blog)
                <div class="col" style="flex: 1 0 30%; max-width: 30%;">
                    <div class="card-blog" style="border: 1px solid #ddd; border-radius: 10px; overflow: hidden;">
                        <img src="{{ asset('storage/' . $blog->image) }}" class="card-img-top" alt="Blog Image" style="width: 100%; height: 200px; object-fit: cover;">
