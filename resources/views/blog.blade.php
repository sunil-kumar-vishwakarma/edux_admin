...
@media (max-width: 767px) {
  ...
  .background-img {
    height: 300px; /* Shortened background image height */
    transform: translateY(100px);
  }
  ...
  .abroad h1 {
    font-size: 1.8em; /* Reduced heading font size */
  }
  ...
  .card18 .card-blog {
    width: 100%; /* Make card take full width inside its container */
  ...
  .card18 .card-body-blog h6 {
    font-size: 1rem;
    color: #333; /* Ensure date text is readable */
    white-space: nowrap; /* Keep the date in a single line */
    overflow: hidden;
    text-overflow: ellipsis;
  }
  ...
  .image-card {
    width: 100%;
    height: 180px; /* Adjust card size for mobile screens */
  }

  .footer-column {
    margin-bottom: 20px; /* Space out the footer columns */
  }
...
@media (max-width: 1024px) {
  ...
  .background-img {
    height: 400px; /* Adjust background image height for tablets */
  ...
  .service h1 {
    font-size: 2.8em; /* Adjust font size for service section */
  }
  ...
  .card18 .col {
    flex: 0 0 45%; /* Take up 48% width for the first two cards */
    margin-bottom: 20px;
  }
  ...
  .card18 .col-third {
    ...
    display: flex;
    justify-content: center;
    margin-top: 20px; /* Add margin to separate it from the first two */
  }

  .card18 .card-blog {
   width: 168%;
        margin: 0px -8px;
    border: 1px solid #ddd; /* Add a subtle border around the cards */
    border-radius: 8px;
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); /* Subtle shadow for depth */
  }

  .card18 .card-img-top {
    height: 200px; /* Adjust card image size */
    object-fit: cover;
    ...
    /* border-radius: var(--bs-card-border-radius); */
        ...
        <!-- <div class="container"> -->
          ...
          <div class="service" id="services">
              ...
              <div class="card18">
                <div class="row-cols-1 row-cols-md-3 g-4" id="card1" style="display: flex;flex-wrap: wrap;">
                  <div class="col">
                    <div class="card-blog">
                      ...
                      <div class="card-body-blog"><br><br>
                        <p class="card-text">Why Choose Canada as an International Student</p><br>
                  ...
                  <div class="col">
                    <div class="card-blog" id="c1">
                      <img src="images/AI035-Banner-1-qvnbbiv0vl6ajzw0bx7l4mbvn2lpuygoy0l63akqm8.png" class="card-img-top" alt="..." id="colimg">
                      <div class="card-body-blog">
                        <br><br>
                        <p class="card-text" >The Early Impacts of Canada’s International Student Cap on Postgraduate Studies</p><br>
                        <h6>October 17, 2024</h6>
                      </div>
