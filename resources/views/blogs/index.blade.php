            ...
            @foreach ($blogs as $blog)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('edit-blog', $blog->id) }}"><button class="btnuser edit-user-btn">Edit</button></a>
                        <button class="btnuser delete-user-btn" onclick="openDeleteModal({{ $blog->id }})">Delete</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
