...
@section('content')
     ...
     <div class="content">
      ...
      <div class="btn4">
        <button class="btn3" ><a href="partner.html" class="anchr">I am a recruitment partner</a></button>
        <button class="btn3"><a href="Institutions.html" class="anchr">I work at an academic institution</a></button>
      </div>
    </div> 
  ...
  <div class="hero-content">
    <div class="text-and-images">
      ...
      <div class="tab-content active" id="students">
        ...
        <a href="Student.html"><button class="btn btn-primary" style="margin-top:15px;">Learn More</button></a>
      </div>
      <div class="tab-content" id="recruitment-partners" style="display: none;">
       ...
       <a href="partner.html"><button class="btn btn-primary" style="margin-top:15px;">Learn More</button></a>
      </div>
      <div class="tab-content" id="partner-institutions" style="display: none;">
       ...
       <a href="Institutions.html"><button class="btn btn-primary" style="margin-top:15px;">Learn More</button></a>
      </div> 
  ...
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="student_register.html"><button type="button" class="btn btn-primary">Student Registration</button></a>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="Institutions.html"><button type="button" class="btn btn-primary" style="margin-top:60px; margin-bottom:-2px;">Partner Inquiry</button></a>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="partner_registration.html"><button type="button" class="btn btn-primary">Recruiter Registration</button></a>
      </div>
    </div>
  </div>
  </div>
