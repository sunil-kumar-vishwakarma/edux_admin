...
@section('content')
    ...
    cursor: pointer;
        ...
        .container {
    position: relative;
    max-height: calc(100vh - 20px); /* Adjusts for padding/margin */
    overflow-y: auto;
}
...
.toggle-password:active {
    ...
    box-shadow: none; /* Remove any potential shadow effect */
...
@media (max-width: 576px) {
    ...
    .form-group .input input[type="tel"] {
        flex: 0 0 30%; /* Set country code field width */
         transform: translateY(-7px);
    }

    .form-group .input input[type="text"] {
        flex: 0.9; /* Expand mobile number field to fill remaining space */
    }
...
.navbar-toggler {
  border: none; /* Add a border to make it visible */
...
.swiper-slide {
  ...
  min-height: 300px; /* Ensure all slides have the same minimum height */
  justify-content: space-between;
  height: 100%; /* This ensures that all slides expand to the same height */
}
...
.testimonial-items .testimonial-text {
  ...
  max-width: 330px;
  margin-bottom: 20px;
  min-height: 50px; /* Ensure consistent height for the text */
  margin-left: 30%;
  color: white;
}
...
.country-content {
  display: none; /* Hide all country content sections by default */
  justify-content: center;
  gap: 10px;
}
...
<style>
  ...
  footer .footer-links {
    ...
    margin-bottom: 20px; /* Space below the link column */
  }

  /* Social icons row - Align icons horizontally */
  footer .social-icons {
    display: flex;
    flex-direction: row; /* Change to row to make icons appear in line */
    justify-content: center; /* Center the icons horizontally */
    gap: 15px; /* Space between icons */
    margin-bottom: 20px; /* Space below the icons row */
  }
  ...
  footer input,
  footer button {
    width: 90%; /* Make form elements wider */
    padding: 12px; /* Padding for ease of use */
  ...
  .details .form-group input {
    ...
    font-size: 1rem; /* Adjust font size for readability */
    border: 1px solid #ccc; /* Ensure consistent border styling */
  ...
  .details .name-container .form-group {
    width: 100%; /* Full width for child form groups */
  }
  ...
  .card-partner {
    width: 90%; /* Adjust card width to fit within mobile screen */
    ...
    border-radius: 8px; /* Rounded corners for design consistency */
  }
...
.card-container .card-partner img{
  ...
  .recruit {
    ...
    gap: 15px; /* Space between h1 and buttons */
  ...
  .recruit .button-container button {
    ...
    padding: 10px 20px; /* Adjust padding for touch-friendly buttons */
    border-radius: 5px; /* Keep buttons rounded */
  }
  ...
  .help {
    margin-top: 20px;
    display: flex;
    flex-direction: column; /* Stack hlogo elements vertically */
    align-items: center; /* Center align elements horizontally */
    gap: 15px; /* Add spacing between hlogo elements */
...
<nav class="navbar navbar-expand-lg">
    ...
    <section class="advertise-section">
      <div class="advertise-text">
        <h1>Advertise your courses on student websites</h1><br>
   ...
   <div class="form">
        <div class="details">
            ...
            <div class="form-group">
                ...
                <textarea id="inputtx" name="long_text" rows="2" cols="60" wrap="hard" maxlength="5000" placeholder="Start from here"></textarea>
                <span class="error" id="aboutError"></span>
            </div>
            <div class="form-group">
                <label for="checkbox">
                    <input type="checkbox" id="checkbox">
                    <p>By submitting this form, you agree to receive communications from Keystone in accordance with our privacy policy. You can unsubscribe from communications at any time*.</p>
                </label>
    ...
    <section class="programs">
      ...
      <div class="elementor-widget-container">
         <img src="images/Fast-50x50.png"></div>
    <div class="elementor-widget-container">
  <h3 class="">Find Programs<br>Faster</h3>		</div>
    </div>  
  ...
  <div class="plogo"> 
    <div class="elementor-widget-container">
    <img src="images/Application-50x50.png"></div>
    <div class="elementor-widget-container">
   <h3 class="">One Easy <br>Application</h3></div>
    </div>   
  ...
  <div class="plogo">
    <div class="elementor-widget-container">
    <img src="images/Platform-50x50.png"></div>
    <div class="elementor-widget-container">
  <h3 class="elementor-heading-title elementor-size-default">Central<br>Platform</h3></div>
</div>
 

  <div class="plogo">
    <div class="elementor-widget-container">
    <img src="images/Data-50x50.png">	</div>
    <div class="elementor-widget-container">
  ...
  <div class="container1">
    ...
    <div class="card-container">
      <div class="card-partner">
        <div class="icon"><img src="images/Local_Support-padv6zedvk8vvy3q0pvo0yom28y4u9vpag42d1aknc.png" alt="Local Support Icon"></div>
        <h3>Local Support</h3>
        <p>Our international recruitment experts are there to support you every step of the way.</p>
      </div>
      
      <div class="card-partner">
        <div class="icon"><img src="images/Education-paegnkurb9vepjv4loech01zlox5m316ufxkunrabs.png" alt="Education Icon"></div>
        <h3>Education</h3>
        <p>Expand your knowledge and stay ahead of your competitors with guided online courses and certificates.</p>
      </div>
      
      <div class="card-partner">
        <div class="icon"><img src="images/Events_Webinars-paej22082k92u293n22pv6gn1uotrmc6qglqb3jdvs.png" alt="Events Icon"></div>
      ...
      <div class="card-partner">
        <div class="icon"><img src="images/Data_Insights-paej03ibtzkknb3i2plp6692hycaqbkbgrobbcfwug.png" alt="Data Icon"></div>
      ...
      <div class="swiper testimonial-wrapper">
        <div class="swiper-wrapper" style="height: 44%;">
          <div class="swiper-slide testimonial-items">
            ...
            <p class="testimonial-text">Discovering Be Better was a game-changer! Their unmatched expertise skyrocketed my online presence and credibility. Highly recommended.</p>
            <h3 class="testimonial-title">Amy</h3>
          </div>
          <div class="swiper-slide testimonial-items">
            <div class="testimonial-img tm-img-2"></div>
            <p class="testimonial-text">Thanks to Be Better, I've unlocked my true potential and transformed how others perceive me. </p>
  ...
  <section class="institutions">
    <h1>We Connect You to the<br> Right Institutions for Your Students</h1>
<br>
    ...
    <section class="country-section">
      ...
      <div class="content-partner">
        <div class="images" id="country1" style="display: none;">
          <img src="{{asset('images/Carleton-University.webp')}}" alt="Country 1 Image 1">
          <img src="{{asset('images/Conestoga.webp')}}" alt="Country 1 Image 2">
          <img src="{{asset('images/George_Brown.webp')}}" alt="Country 1 Image 3">
          <img src="{{asset('images/YorkvilleU.webp')}}" alt="Country 1 Image 4">
          <img src="{{asset('images/UWaterloo.webp')}}" alt="Country 1 Image 5">
        </div>
        <div class="images" id="country2" style="display: none;">
          <img src="{{asset('images/UWaterloo.webp')}}" alt="Country 2 Image 1">
          <img src="{{asset('images/YorkvilleU.webp')}}" alt="Country 2 Image 2">
          <img src="{{asset('images/George_Brown.webp')}}" alt="Country 2 Image 3">
          <img src="{{asset('images/Conestoga.webp')}}" alt="Country 2 Image 4">
          <img src="{{asset('images/Carleton-University.webp')}}" alt="Country 2 Image 5">
        </div>
        <div class="images" id="country3" style="display: none;">
          <img src="{{asset('images/Conestoga.webp')}}" alt="Country 3 Image 1">
          <img src="{{asset('images/Carleton-University.webp')}}" alt="Country 3 Image 2">
          <img src="{{asset('images/George_Brown.webp')}}" alt="Country 3 Image 3">
          <img src="{{asset('images/YorkvilleU.webp')}}" alt="Country 3 Image 4">
          <img src="{{asset('images/UWaterloo.webp')}}" alt="Country 3 Image 5">
        </div>
        <div class="images" id="country4" style="display: none;">
          <img src="{{asset('images/UWaterloo.webp')}}" alt="Country 4 Image 1">
          <img src="{{asset('images/Carleton-University.webp')}}" alt="Country 4 Image 2">
          <img src="{{asset('images/YorkvilleU.webp')}}" alt="Country 4 Image 3">
          <img src="{{asset('images/George_Brown.webp')}}" alt="Country 4 Image 4">
          <img src="{{asset('images/Conestoga.webp')}}" alt="Country 4 Image 5">
        </div>
        <div class="images" id="country5" style="display: none;">
          <img src="{{asset('images/George_Brown.webp')}}" alt="Country 5 Image 1">
          <img src="{{asset('images/UWaterloo.webp')}}" alt="Country 5 Image 2">
          <img src="{{asset('images/Carleton-University.webp')}}" alt="Country 5 Image 3">
          <img src="{{asset('images/Conestoga.webp')}}" alt="Country 5 Image 4">
          <img src="{{asset('images/YorkvilleU.webp')}}" alt="Country 5 Image 5">
        </div>
      </div>
    
    

      <button class="btn btn-primary"><a href="{{route('explr_school_Programs')}}">Explore Institutions</a></button>
    </section>
  </section>
...
<!-- Custom Modal -->
      ...
      <div class="registration-container">
        ...
        <span class="close" onclick="closeModal()">&times;</span>
            ...
            <div class="form-group">
               ...
               <button type="button" class="toggle-password" style="width: 10px;  margin-right: 40px; margin-top: 6px; border: none "> 
            ...
            <div class="tc">
              <a href="Terms_and _condition.html">Terms and Conditions  <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
              <a href="privacy_policy.html" id="pp"> Privacy Policy  <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
            </div>

            
            <div class="checkbox">
                <label><input type="checkbox">
                    I have reviewed and consented to the ApplyBoard Terms and Conditions and Privacy Policy The foregoing information/application/document(s) are true and complete. I understand that a false statement or supporting documents may disqualify me from becoming a Recruitment Partner for Edu-X.
                </label>   
            </div>
  ...
  <section class="help">
    <div class="help-logo">
      ...
      <div class="hlogo">
    <div class="elementor-widget-container">
       <img src="images/Students-Helped-50x50.png"></div>
  <div class="elementor-widget-container">
<h3 class="">1,000,000+<br><small>Students<br>Helped</small></h3>		</div>
  </div>  


<div class="hlogo"> 
  <div class="elementor-widget-container">
  <img src="images/Acceptance-Rate-50x50.png"></div>
  <div class="elementor-widget-container">
    <h3 class="">95%<br><small>Acceptance<br>Rate</small></h3>		</div>
  </div>   


<div class="hlogo">
  <div class="elementor-widget-container">
  <img src="images/School-Partnerships-50x50.png"></div>
  <div class="elementor-widget-container">
    <h3 class="">1500+<br><small>Institutions<br>Partnership</small></h3>		</div>
</div>


<div class="hlogo">
  <div class="elementor-widget-container">
  <img src="images/50M-50x50.png">	</div>
  <div class="elementor-widget-container">
    <h3 class="">$100M+<br><small>Students<br>Helped</small></h3>		</div>	
</div>
  </div>
  </section>
...
document.querySelector('.country-btn').click();
 ...
 const dropdownBtn = document.getElementById('dropdownBtn');
      ...
      function validateForm(event) {
            ...
            if (message === "") { showError("msgError", "Message is required"); isValid = false; } else { clearError("msgError"); }
            if (school === "") { showError("schoolError", "School or Organisation is required"); isValid = false; } else { clearError("schoolError"); }
            if (firstName === "") { showError("firstNameError", "First Name is required"); isValid = false; } else { clearError("firstNameError"); }
            if (lastName === "") { showError("lastNameError", "Last Name is required"); isValid = false; } else { clearError("lastNameError"); }
            if (email === "" || !email.includes("@")) { showError("emailError", "Valid Email is required"); isValid = false; } else { clearError("emailError"); }
            if (about === "") { showError("aboutError", "This field is required"); isValid = false; } else { clearError("aboutError"); }
            if (!checkbox) { showError("checkboxError", "You must agree to the terms"); isValid = false; } else { clearError("checkboxError"); }
...
const checkPassword = () => {
    ...
    const passwordChecks = [
        { regex: /.{12,}/, element: passwordRequirements[0] }, // At least 12 characters
        { regex: /[a-z]/, element: passwordRequirements[1] },  // A lowercase letter
        { regex: /[A-Z]/, element: passwordRequirements[2] },  // An uppercase letter
        { regex: /[0-9]/, element: passwordRequirements[3] },  // A number
        { regex: /[!@#$%^&*(),.?":{}|<>]/, element: passwordRequirements[4] }, // A symbol
        { regex: new RegExp(firstNameValue, 'i'), element: passwordRequirements[5], shouldFail: true }, // Does not have first name
        { regex: new RegExp(lastNameValue, 'i'), element: passwordRequirements[6], shouldFail: true }  // Does not have last name
    ];

    passwordChecks.forEach(check => {
        if (check.shouldFail) {
            if (check.regex.test(password)) {
                check.element.style.color = 'red'; // Invalid, password should not contain first or last name
            } else {
                check.element.style.color = 'green'; // Valid, password does not contain first or last name
            }
        } else {
            if (check.regex.test(password)) {
