...
<div class="work">
    ...
    <span ><img src="{{asset('images/earth.png')}}" style="height: 60px; width: 50px;"><h3>5</h3><br><p>Destination Countries</p></span>
</div>
...
<div class="destinations">
  ...
  <div class="destination-card">
    <img src="{{asset('images/study_in_ireland_a72bfdef5c.webp')}}" alt="Ireland">
    <div class="destination-title">Study in Ireland</div>
    <button><a href="studyinuk.html">Explore →</a></button>
  </div>
</div>
</section>
...
<div class="hero" id="added">
  ...
  <div class="card-deck">
    ...
    <div class="card-students">
      ...
      <div class="card-body">
        <h5 class="card-title">PhD Programs & Research Degrees</h5>
        <p class="card-text-student">This is a wider card with supporting text below as a additional content. This card has even longer height .</p>
