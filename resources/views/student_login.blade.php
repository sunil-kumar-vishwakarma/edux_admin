...
;
      ...
      @media (max-width: 576px) {
          ...
          .navbar-toggler {
              ...
              background-color: transparent; /* Optional: set background if not visible */
          }
          ...
          .navbar .btn-group {
              margin-top: 10px; /* Adjust button group position */
          }
      }
...
@media (min-width: 768px) and (max-width: 1024px) {
    ...
    .footer-column {
        width: 25%; /* Adjust width to fit all columns in one row */
        text-align: center;
    }
  ...
  <div class="login-container">
    <div class="card-login">
      <img
        src="images/edu-x white.png"
        alt="Edu-x Logo"
        style="height: 70px; width: 75px; margin-left: 21px"
      />
      <h2>Log In</h2>
      <div class="card-body">
        <form id="loginForm">
        ...
        <div class="registr">
          ...
          <br />
          <a href="student_register.html">Register as a Student</a
          ><br /><br />
          <a href="partner_registration.html" class="a3"
            >Register as a Recruitment Partner</a
          >
        </div>
        <br />
