...
@media (max-width: 768px) {
 ...
 .navbar-collapse.collapse.show {
        ...
        height: 350px; /* Adjust the height automatically */
        padding: -20px;
        z-index: 1000;
        border: none;
    ...
    .navbar-collapse{
      ...
      background-color: #1652b4; /* Same color as navbar */
      width: 100%;
    }
    ...
    .navbar-nav {
        ...
        background-color: #1652b4; /* Same as navbar color */
      ...
      <div class="card1-student">
        <div class="card-student">
          ...
          <div class="card-body-student">
            <div class="buttons">
            <button> <a href="#" aria-label="Facebook" target="_blank"><i class="fab fa-facebook"></i></a>Facebook</button>
            <button> <a href="#" aria-label="Google" target="_blank" id="google"><i class="fa-brands fa-google"></i></a>Google</button>
          </div>
            ...
            <p id="bold">*Minimum Password Requirements</p>
            <small>At least 10 characters. One lowercase letter, One uppercase letter, One number, One symbol.</small>

            <div class="checkbox">
              <input type="checkbox" id="tc" name="tc" required>
              <label for="tc">I have read and agree to the <a href="Terms_and _condition.html">Terms and Conditions</a> and the <a href="privacy_policy.html">Privacy and Cookies Policy*</a>.</label>   
            </div>
            <div class="account">
              <button type="button" class="btn btn-primary" id="btn1"><a href="#">Create Account</a></button>
            </div>
            <div id="login">
            <p >Already have an account? <a href="student_login.html"> Login</a></p>
          </div>
            <small>*If you are a minor in your jurisdiction, your parent or legal guardian must agree to the above terms.</small><br>
