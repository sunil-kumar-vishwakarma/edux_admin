...
<link rel="stylesheet" href="{{asset('css/events.css')}}">
      <style>
        .background-img {
            ...
            background-image: url('/images/learn-more.jpg'); /* Path to your image */
...
.text-and-images #img1,#img2,#img3{
  display: none;
}
...
#recruitment-partners, #students, #partner-institutions{
  background-color: white;
  margin-top: 45px;
  font-size: large;
}
...
ul li::marker {
    color: blue; /* Change bullet color */
    font-size: 1em; /* Optional: Customize bullet size */
...
@media (max-width:768px) {
  ...
  .background-img {
    height: 486px; /* Adjust for tablets */
           margin: -32px -20px;
...
@media (min-width: 1024px) {
  ...
  .card1-webinars .card-webinar-learn {
    width: 30%; /* Three columns for larger screens */
    margin-bottom: 30px;
  }
...
@media (min-width: 1440px) {
  .background-img {
    height: 500px; /* Adjust for large desktops */
            margin: -31px -150px;
  }
  ...
  .card1-webinars .card-webinar-learn {
    width: 22%; /* Four columns for large screens */
    margin-bottom: 30px;
  }
...
@media (min-width: 1600px) {
  ...
  .background-img {
    height: 600px; /* Further height for very large screens */
  }
  ...
  .card1-webinars .card-webinar-learn {
    width: 20%; /* 5 columns for ultra-wide screens */
  }
...
<main class="hero">
    ...
    <div class="hero-content">
      <div class="text-and-images">
        ...
        <div class="tab-content active" id="recruitment-partners">
            <div class="visa">
            <div>
        ...
        <div class="tab-content active" id="partner-institutions">
            <div class="visa">
            <div>
        ...
        <div class="tab-content active" id="test">
            <div class="visa">
...
document.getElementById('scrollButton').addEventListener('click', function () {
    ...
    const targetPosition = targetSection.offsetTop - navbarHeight - 20; // Adjust scroll position (add some extra margin)
